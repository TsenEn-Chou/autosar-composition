...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/slprj/autosar/_sharedutils -I$(MATLAB_ROOT)/toolbox/coder/autosar/rte -I$(START_DIR)/autosar_tpc_throttle_sensor1_autosar_rtw/stub -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/autosar_tpc_throttle_sensor2_autosar_rtw/stub
...
SRCS = $(START_DIR)/slprj/autosar/_sharedutils/look1_iflf_linlcpw.c
...
look1_iflf_linlcpw.o : $(START_DIR)/slprj/autosar/_sharedutils/look1_iflf_linlcpw.c
	$(CC) $(CFLAGS) -o "$@" "$<"
