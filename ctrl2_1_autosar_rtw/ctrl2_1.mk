###########################################################################
## Makefile generated for component 'ctrl2_1'. 
## 
## Makefile     : ctrl2_1.mk
## Generated on : Fri Nov 25 15:45:26 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ctrl2_1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ctrl2_1
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/ctrl2_1_autosar_rtw -I$(MATLAB_ROOT)/toolbox/coder/autosar/rte -I$(START_DIR)/ctrl2_1_autosar_rtw/stub -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=ctrl2_1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/ctrl2_1_autosar_rtw/ctrl2_1.c $(START_DIR)/ctrl2_1_autosar_rtw/ctrl2_1_data.c $(START_DIR)/ctrl2_1_autosar_rtw/stub/Rte_ctrl2.c
...
OBJS = ctrl2_1.o ctrl2_1_data.o Rte_ctrl2.o
...
%.o : $(START_DIR)/ctrl2_1_autosar_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ctrl2_1_autosar_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ctrl2_1_autosar_rtw/stub/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ctrl2_1_autosar_rtw/stub/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ctrl2_1.o : $(START_DIR)/ctrl2_1_autosar_rtw/ctrl2_1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ctrl2_1_data.o : $(START_DIR)/ctrl2_1_autosar_rtw/ctrl2_1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Rte_ctrl2.o : $(START_DIR)/ctrl2_1_autosar_rtw/stub/Rte_ctrl2.c
	$(CC) $(CFLAGS) -o "$@" "$<"
